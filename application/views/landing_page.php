                ...
                <div class="card mb-3 mr-3"  style="width: 25rem;">
                  <img src="<?php echo base_url().'/assets/uploads/'.$brg->gambar?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <a  class="btn btn-success mb-1"><?php echo rupiah($brg->harga)?> </a>
                        <?php echo anchor('Welcome/tambah_ke_keranjang/'.$brg->id,'<div class="btn btn-primary mb-1"><i class="fa fa-shopping-cart"></i> Tambah Ke Keranjang</div>') ?>

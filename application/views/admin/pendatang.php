        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="<?= site_url('Form_pendatang');?>" class="btn btn-info"><i class="bi bi-plus me-1"></i> Tambah</a>
                ...
                <tbody>
                  <tr>
                    ...
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#basicModal">
                        ...
                        <a href="<?php echo base_url('Pendatang/edit_page') ?>/<?php echo $value->id ?>"  class="btn btn-warning btn-icon-text"><i class="ti-file btn-icon-prepend"></i>Edit</a>

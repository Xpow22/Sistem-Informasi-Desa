        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?php echo base_url() . 'Form_pindahan/tambah_data'; ?>" method="post">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="alamat" class="col-sm-2 col-form-label">Alasan Pindah</label>
                  <div class="col-sm-10">
                    <input type="text" id="alasan_pindah" name="alasan_pindah" class="form-control">
                  </div>
                </div>
